...
def get_scatter_chart(entered_site,entered_range):
    filtered_df2_1 = spacex_df[(spacex_df['Payload Mass (kg)'] > entered_range[0]) & (spacex_df['Payload Mass (kg)'] < entered_range[1])]
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df2_1, 
        x='Payload Mass (kg)', y='class',  
        title='Correlation between Payload and Succes for al Sites',
